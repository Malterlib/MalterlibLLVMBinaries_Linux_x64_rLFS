...
class SBAddressRange(object):
    ...
    def GetBaseAddress(self) -> "lldb::SBAddress":
...
class SBAddressRangeList(object):
    ...
    def GetAddressRangeAtIndex(self, idx: "uint64_t") -> "lldb::SBAddressRange":
...
class SBBlock(object):
    ...
    def GetRanges(self) -> "lldb::SBAddressRangeList":
...
class SBCommandInterpreter(object):
    ...
    def SetCommandOverrideCallback(self, command_name: "char const *", callback: "lldb::CommandOverrideCallback") -> "bool":
    ...
    def GetTranscript(self) -> "lldb::SBStructuredData":
...
class SBCommandInterpreterRunOptions(object):
    ...
    * AllowRepeats    false
    ...
    def SetAllowRepeats(self, arg2: "bool") -> "void":
...
class SBCommandReturnObject(object):
    ...
    def GetErrorData(self) -> "lldb::SBStructuredData":
...
class SBSaveCoreOptions(object):
    ...
    * eSaveCoreCustomOnly Custom defers entirely to the SBSaveCoreOptions object and will only save what is specified. 
    ...
    def SetPluginName(self, plugin: "char const *") -> "lldb::SBError":
        r"""
    ...
    def SetStyle(self, style: "lldb::SaveCoreStyle") -> "void":
        r"""
    ...
    def GetStyle(self) -> "lldb::SaveCoreStyle":
        r"""
    ...
    def SetOutputFile(self, output_file: "SBFileSpec") -> "void":
        r"""
    ...
    def GetOutputFile(self) -> "lldb::SBFileSpec":
        r"""
    ...
    def SetProcess(self, process: "SBProcess") -> "lldb::SBError":
        r"""
    ...
    def AddThread(self, thread: "SBThread") -> "lldb::SBError":
        r"""
    ...
    def AddMemoryRegionToSave(self, region: "SBMemoryRegionInfo") -> "lldb::SBError":
        r"""
    ...
    def GetThreadsToSave(self) -> "lldb::SBThreadCollection":
        r"""
...
class SBDebugger(object):
    ...
    @staticmethod
    def SupportsLanguage(language: "lldb::LanguageType") -> "bool":
    ...
    def AddDestroyCallback(self, destroy_callback: "lldb::SBDebuggerDestroyCallback") -> "lldb::callback_token_t":
    ...
    def RemoveDestroyCallback(self, token: "lldb::callback_token_t") -> "bool":
...
def SBDebugger_SupportsLanguage(language: "lldb::LanguageType") -> "bool":
    r"""SBDebugger_SupportsLanguage(lldb::LanguageType language) -> bool"""
    return _lldb.SBDebugger_SupportsLanguage(language)
...
class SBExpressionOptions(object):
    ...
    def SetLanguage(self, *args) -> "void":
        r"""
...
class SBFrame(object):
    ...
    def GetLanguageSpecificData(self) -> "lldb::SBStructuredData":
...
class SBLanguageRuntime(object):
    ...
    @staticmethod
    def SupportsExceptionBreakpointsOnCatch(language: "lldb::LanguageType") -> "bool":
    ...
    @staticmethod
    def GetThrowKeywordForLanguage(language: "lldb::LanguageType") -> "char const *":
    ...
    @staticmethod
    def GetCatchKeywordForLanguage(language: "lldb::LanguageType") -> "char const *":
...
def SBLanguageRuntime_LanguageIsCPlusPlus(language: "lldb::LanguageType") -> "bool":
    r"""SBLanguageRuntime_LanguageIsCPlusPlus(lldb::LanguageType language) -> bool"""
    return _lldb.SBLanguageRuntime_LanguageIsCPlusPlus(language)

def SBLanguageRuntime_LanguageIsObjC(language: "lldb::LanguageType") -> "bool":
    r"""SBLanguageRuntime_LanguageIsObjC(lldb::LanguageType language) -> bool"""
    return _lldb.SBLanguageRuntime_LanguageIsObjC(language)

def SBLanguageRuntime_LanguageIsCFamily(language: "lldb::LanguageType") -> "bool":
    r"""SBLanguageRuntime_LanguageIsCFamily(lldb::LanguageType language) -> bool"""
    return _lldb.SBLanguageRuntime_LanguageIsCFamily(language)

def SBLanguageRuntime_SupportsExceptionBreakpointsOnThrow(language: "lldb::LanguageType") -> "bool":
    r"""SBLanguageRuntime_SupportsExceptionBreakpointsOnThrow(lldb::LanguageType language) -> bool"""
    return _lldb.SBLanguageRuntime_SupportsExceptionBreakpointsOnThrow(language)

def SBLanguageRuntime_SupportsExceptionBreakpointsOnCatch(language: "lldb::LanguageType") -> "bool":
    r"""SBLanguageRuntime_SupportsExceptionBreakpointsOnCatch(lldb::LanguageType language) -> bool"""
    return _lldb.SBLanguageRuntime_SupportsExceptionBreakpointsOnCatch(language)

def SBLanguageRuntime_GetThrowKeywordForLanguage(language: "lldb::LanguageType") -> "char const *":
    r"""SBLanguageRuntime_GetThrowKeywordForLanguage(lldb::LanguageType language) -> char const *"""
    return _lldb.SBLanguageRuntime_GetThrowKeywordForLanguage(language)

def SBLanguageRuntime_GetCatchKeywordForLanguage(language: "lldb::LanguageType") -> "char const *":
    r"""SBLanguageRuntime_GetCatchKeywordForLanguage(lldb::LanguageType language) -> char const *"""
    return _lldb.SBLanguageRuntime_GetCatchKeywordForLanguage(language)
...
class SBLineEntry(object):
    ...
    def GetSameLineContiguousAddressRangeEnd(self, include_inlined_functions: "bool") -> "lldb::SBAddress":
...
class SBProcess(object):
    ...
    def FindRangesInMemory(self, buf: "void const *", ranges: "SBAddressRangeList", alignment: "uint32_t", max_matches: "uint32_t", error: "SBError") -> "lldb::SBAddressRangeList":
    ...
    def FindInMemory(self, buf: "void const *", range: "SBAddressRange", alignment: "uint32_t", error: "SBError") -> "lldb::addr_t":
    ...
    def SetAddressMask(self, *args) -> "void":
        r"""
    ...
    def SetAddressableBits(self, *args) -> "void":
        r"""
    ...
    def FixAddress(self, *args) -> "lldb::addr_t":
        r"""
    ...
    def GetStatus(self, status: "SBStream") -> "void":
...
class SBProgress(object):
    ...
    def Increment(self, amount: "uint64_t", description: "char const *"=None) -> "void":
...
class SBStatisticsOptions(object):
    ...
    def SetSummaryOnly(self, b: "bool") -> "void":
        r"""
    ...
    def SetIncludeTargets(self, b: "bool") -> "void":
    ...
    def SetIncludeModules(self, b: "bool") -> "void":
    ...
    def SetIncludeTranscript(self, b: "bool") -> "void":
    ...
    def SetReportAllAvailableDebugInfo(self, b: "bool") -> "void":
        r"""
...
class SBTarget(object):
    ...
    def GetStatistics(self, *args) -> "lldb::SBStructuredData":
        r"""
...
class SBTypeStaticField(object):
    ...
    def GetConstantValue(self, target: "SBTarget") -> "lldb::SBValue":
...
class SBType(object):
    ...
    def GetByteAlign(self) -> "uint64_t":
    ...
    def GetStaticFieldWithName(self, name: "char const *") -> "lldb::SBTypeStaticField":
...
class SBValue(object):
    ...
    def GetValueAsAddress(self) -> "lldb::addr_t":
        r"""
    ...
    def GetSyntheticValue(self) -> "lldb::SBValue":
    ...
    def CreateBoolValue(self, name: "char const *", value: "bool") -> "lldb::SBValue":
